...
from mobile_settings.views import MenuListAPIView, MPNSDeviceAPIView, MPNSDeviceCreateAPIView, MPNSDetailAPIView
...
urlpatterns = [
    ...
    url(r'^push/device/mpns/(?P<id>\d+)/', MPNSDeviceAPIView.as_view(), name='mpns_detail_api'),
