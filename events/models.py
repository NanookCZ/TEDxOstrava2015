...
class Event(models.Model):
	...
	hosted_by = models.ForeignKey(_('hosted_by'), User)
	...
	created_date = models.DateTimeField(_('created_date'), auto_now_add = True, auto_now = False)
	updated_date = models.DateTimeField(_('updated_date'), auto_now_add = False, auto_now = True)
	event_theme = models.ForeignKey(_('event_theme'), Theme, blank = True, null = True)
	active = models.BooleanField(_('active'), default = True)
	speakers = models.ManyToManyField(_('speakers'), Speaker, blank = True, null = True)
	partners = models.ManyToManyField(_('partners'), Partner, blank = True, null = True)
