    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_start', models.DateField(help_text='Start of the event.', null=True, verbose_name='event_start', blank=True)),
                ('event_end', models.DateField(help_text='End of the event.', null=True, verbose_name='event_end', blank=True)),
                ('event_start_time', models.CharField(help_text='Start time of the event.', max_length=50, null=True, verbose_name='event_start_time', blank=True)),
                ('event_end_time', models.CharField(help_text='End time of the event.', max_length=50, null=True, verbose_name='event_end_time', blank=True)),
                ...
                ('latitude', models.CharField(max_length=10, null=True, verbose_name='latitude', blank=True)),
                ('longtitude', models.CharField(max_length=10, null=True, verbose_name='longtitude', blank=True)),
                ...
                ('facebook_url', models.CharField(max_length=50, null=True, verbose_name='facebook_url', blank=True)),
                ('twitter_url', models.CharField(max_length=50, null=True, verbose_name='twitter_url', blank=True)),
                ('share_message', models.CharField(default='TEDxOstrava - Novinky', max_length=50, verbose_name='share_message')),
            ],
            options={
                'verbose_name': 'Event',
